...
class Payment extends Component {
   ...
   */
  createTicket = () => {
    if (this.state.CNUM.length !== 16) {
      window.alert("Please Enter Valid Card Number");
    } 
    else if(this.state.CVV.length !== 3){
        window.alert("Enter 3 Digit cvv ")
    }
    else if(this.state.CNAME.length === 0){
        window.alert("Enter Card Holder Name ")
    }
    else if(this.state.CEX.length === 0){
        window.alert(" Insert Card Expiry Detail ")
    }
    else {
                              ...
                              <div className="col-md-6">
                                <div className="form-group">
                                  ...
                                  <input
                                    ...
                                    className="form-control"
                                    onChange={(e) =>
                                        this.setState({ CEX: e.target.value })
                                      }
                                    required
                                  />
                                </div>
